...
public class Pawn extends Piece{
    ...
    public int judgeMove(int i, int j){
        ...
        if (this.getCol() == j && Math.abs(this.getRow()-i)<=2){
            ...
            if (this.numMoved == 0 && i - this.getRow() == this.getColor() * 2){
                ...
                System.out.println("color ="+numMoved);
                return -3;
            }
        }
     ...
     * @return     Deque<Position> of all valid positions
     */
    public Deque<Position> potentialMoves(){
        ...
        if (numMoved == 0 && judgeMove(row + this.getColor(), col) == 0){
