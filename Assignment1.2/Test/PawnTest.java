...
public class PawnTest{
    ...
    public void testPotentialMove() {
        ...
        test.printBoard();
        Deque<Position> positionsQue = ((Pawn) pawn).potentialMoves();
        Deque<Position> positionsQue_1 = ((Pawn) pawn_1).potentialMoves();

        for (Position pos : positionsQue_1){
